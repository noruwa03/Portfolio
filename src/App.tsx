          ...
          <ul className="lg:place-content-end place-content-center lg:mt-0 mt-20 flex lg:flex-row flex-col flex-wrap items-center w-full lg:space-x-12 lg:space-y-0 space-y-8">
            ...
            <li className="flex flex-row items-center">
              ...
              <svg
                ...
                height="18"
                fill="currentColor"
                className="bi bi-moon-stars-fill lg:fill-gray-600 fill-white"
                viewBox="0 0 16 16"
                ref={moon}
                onClick={themeSwitch}
              >
          ...
          <li>
            <a href="https://github.com/noruwa03">
              <svg
                ...
                className="feather feather-github transition ease-in-out motion-reduce:transition-none motion-reduce:hover:transform-none  hover:-translate-y-1 stroke-indigo-800 hover:stroke-red-400"
              >
                <title>GitHub</title>
          ...
          <li>
            <a href="https://twitter.com/obasekinoruwa">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="feather feather-twitter transition ease-in-out motion-reduce:transition-none motion-reduce:hover:transform-none  hover:-translate-y-1 stroke-indigo-800 hover:stroke-red-400"
              >
                <title>Twitter</title>
          ...
          <li>
            <a href="https://linkedin.com/in/obaseki-noruwa-184a4020b">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="feather feather-linkedin transition ease-in-out motion-reduce:transition-none motion-reduce:hover:transform-none  hover:-translate-y-1 stroke-indigo-800 hover:stroke-red-400"
              >
